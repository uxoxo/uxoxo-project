...
*
*
* path:      /inc/uxoxo/templates/component/input/text_input.hpp
* link(s):   TBA
...
void ti_history_push(text_input<_F, _I>& ti)
{
    ...
    if (ti.history.size() > ti.history_max)
    {
...
NS_INTERNAL
    ...
    template <typename _Type>
    struct has_placeholder_member<_Type, std::void_t<
        decltype(std::declval<_Type>().placeholder)
    >> : std::true_type {};
    ...
    template <typename _Type>
    struct has_sel_anchor_member<_Type, std::void_t<
        decltype(std::declval<_Type>().sel_anchor)
    >> : std::true_type {};
    ...
    template <typename _Type>
    struct has_history_member<_Type, std::void_t<
        decltype(std::declval<_Type>().history)
    >> : std::true_type {};
    ...
    template <typename _Type>
    struct has_validators_member<_Type, std::void_t<
        decltype(std::declval<_Type>().validators)
    >> : std::true_type {};
    ...
    template <typename _Type>
    struct has_masked_member<_Type, std::void_t<
        decltype(std::declval<_Type>().masked)
    >> : std::true_type {};
    ...
    template <typename _Type>
    struct has_word_wrap_member<_Type, std::void_t<
        decltype(std::declval<_Type>().word_wrap)
    >> : std::true_type {};
}
...
NS_END  // namespace text_input_traits
NS_END  // component
NS_END  // uxoxo
